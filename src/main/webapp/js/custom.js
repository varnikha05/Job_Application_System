jQuery(function($) {
  ...
  var counterInit = function() {
	...
	owlCarouselFunction();
		 ...
		 // Remove Quill initialization for #editor-2 to prevent JS errors
		 var quillInit = function() {
				 ...
				 // Only initialize Quill if #jobDescriptionEditor exists
				 if ( $('#jobDescriptionEditor').length > 0 ) {
						 var quill = new Quill('#jobDescriptionEditor', {
							 modules: {
